package com.shgbit.bailiff.mvp.court.adapter;
            ...
            if (item.getLayoutId() == expandedList.get(position).getValue().getLayoutId()) {
                ...
                if (item.getClickId() != 0) {
                    ...
                    ((TreeViewBinder.ViewHolder) holder).findViewById(item.getClickId()).setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            setLastToggleClickViewHolder((TreeViewBinder.ViewHolder) holder);
                            itemClick((TreeViewBinder.ViewHolder) holder, v, !expandedList.get(holder.getLayoutPosition()).isExpanded(), expandedList.get(holder.getLayoutPosition()));
                        }
                    });
                }
            }
...
//        notifyDataSetChanged();
    ...
    //每条点击
    public abstract void itemClick(TreeViewBinder.ViewHolder viewHolder, View view, boolean isOpen, TreeNode treeNode);
